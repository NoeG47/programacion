...
public class TresenRayaModNoeGuaman {
	...
	public static void seleccionarFichas(char carac) {
		...
		if (carac == ficha1 ) {
			...
			System.out.println("Jugador 1 es" + ficha1);
		...
		if (carac == ficha2 ) {
			System.out.println("Se ha asignado correctamente");
			System.out.println("Jugador 1 es" + ficha2);
